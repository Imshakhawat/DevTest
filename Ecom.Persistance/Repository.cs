...
namespace Ecom.Persistance
{
    ...
    Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>> include = null)
     ...
     bool isTrackingOff = false)
        ...
        public Task EditAsnc(TEntity entityToUpdate)
        {
            throw new NotImplementedException();
        }

        Task<IList<TEntity>> IRepository<TEntity, TKey>.GetAsync(Expression<Func<TEntity, bool>> filter, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> Orderby, Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>> include, int pageIndex, int pageSize, bool isTrackingOff)
        {
            throw new NotImplementedException();
        }
        ...
        TEntity IRepository<TEntity, TKey>.GetByIdAsync(TKey id)
        {
            throw new NotImplementedException();
        }

        public Task<int> GenCountAsync(Expression<Func<TEntity, bool>> filter = null)
        {
            throw new NotImplementedException();
        }

        public Task<(IList<TEntity> data, int total, int totalDisplay)> GetDynamicAsync(Expression<Func<TEntity, bool>> filter = null, string orderBy = null, Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>> include = null, int pageIndex = 1, int pageSize = 10, bool isTrackingOff = false)
        {
            throw new NotImplementedException();
        }
    }
